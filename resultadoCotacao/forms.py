...
class CotacaoForm(forms.ModelForm):
    ...
    def get_valores_planos(self):
        ...
        if not (marca and modelo and ano and versao):
            return []
        ...
        # Buscar planos ativos do veículo, ou planos padrão se não houver
        ...
        resultado = []
        for plano in planos:
            valor_calculado = veiculo.valor_seguro_base + plano.preco_base
            resultado.append({
                'nome': plano.nome,
